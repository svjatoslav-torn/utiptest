...
{
    /**
     * Метод для посева данных в БД в дефолтных количествах
     * 
     * @return void
     */
    public function actionIndex()
    {
        ...
        echo PHP_EOL;
        echo 'http://hostname/auth/login  -  получение Bearer токена. Поля: string $email, string $password';
        echo PHP_EOL;
        echo PHP_EOL;
    ...
    public function actionCategories(int $count = 5)
    {
        ...
        $string = "В таблице \"Категории\" успешно создано {$count} записей";
        echo $string;
        echo PHP_EOL;
    }
